...
module.exports = function(num){
	switch(num){
		...
		case 1:
			...
			text += "Hi. I’m Josh, Ash’s younger brother. I need your help. <br> Recently Ash built a website for a college project where he gives people fortune cookies. But he left the file on his desktop and left his computer unlocked.<br> Me being curious, wanted to see how he made it. So I opened the file. Since I’m learning to build one for myself, I tried to do some improvements but ended up bricking the file. <br>Can you help me find the fault? I’ll let you see your fortune in return.";
			text += "<br>The webpage is at ‘level-1’.";
			return text;
		case 2:
			var text = "Welcome to level 2<br>";
			text += "Josh is a not so intelligent kid who’s best friend Samuel is the most intelligent kid in school. And Samuel has made his personal webpage where he writes and publishes his blogs. <br>He’d love to get your reviews and help on some of his blogs. In return, you may get what you’re looking for.";
		...
		case 6:
			...
			text += "<br>P.S. Sorry, we couldn't afford big numbers!</a>";
			text += "<br><a href='RSA/RSA.zip'> Files for this level.</a>";
			return text;
		case 7:
			var text = "Welcome to level 7<br>";
			text += "Ash has come up with his version of cypher called “Bore’s Code” acknowledging the boring afternoon that seeded it.<br>\
He had encrypted a file in Bore’s Code and but after encrypting, his friend Sunny accidently deleted the source code.<br> Thanks to version control, they were able to pull out some of it, but the decryption logic is still missing.<br>\
As a result, now no one knows how to decrypt the secret he once wrote. Can you help him? If you do, he’ll provide you with a flag for this round. All the best!"
			text += "<br><a href='level7/secret'> The encrypted file </a>";
			text += "<br><a href='level7/borescode.cpp'> Ash's code</a>";
			return text;
		// case 8:
